	...
	<div class="content">
		<div class="container-fluid">
			...
			<div class="row">
				...
				<!--<div class="col-sm-4 col-xs-12">
					<div class="panel panel-default">
						<div class="panel-heading"><h4 class="panel-title">Declaraciones recibidas por Internet</h4></div>
						<div class="embed-responsive others">
							<div class="panel-body embed-responsive-item">
								<div class="row">
									<div class="col-xs-12" id="hi"></div>
								</div>
							</div>
						</div>
					</div>
				...
				<!--<div class="col-sm-4 col-xs-12">
					<div class="panel panel-default">
						<div class="panel-heading"><h4 class="panel-title">Recepción por Entidades Externas</h4></div>
						<div class="embed-responsive others">
							<div class="panel-body embed-responsive-item">
								<div class="row">
									<div class="col-xs-12" id="j"></div>
								</div>
							</div>
						</div>
					</div>
